...
class CreditsState extends MusicBeatState {
	...
	static var psych(default, never):Array<Array<String>> = [
		...
		[''],
		['Engine Contributors'],
		['crowplexus', 			'crowplexus', 		'Input System v3 and Other PRs', 								'https://twitter.com/crowplexus', 			'CFCFCF'],
		...
		['MAJigsaw77', 			'jigsaw', 			'.MP4 Video Loader Library (hxvlc)', 							'https://twitter.com/MAJigsaw77', 			'5F5F5F'],
