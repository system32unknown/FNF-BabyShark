...
class SustainStrip extends FlxStrip {
	...
	static final noteIndices:Array<Int> = [0, 1, 2, 1, 3, 2, 2, 3, 4, 3, 4, 5]; // makes 4 triangles
	...
	public function constructVertices(noteData:NotePositionData, thisNotePos:Vector3D, nextHalfNotePos:NotePositionData, nextNotePos:NotePositionData,
			flipGraphic:Bool, reverseClip:Bool) {
