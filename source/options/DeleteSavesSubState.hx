...
class DeleteSavesSubState extends MusicBeatSubstate {
    ...
    var grpName:FlxTypedGroup<Alphabet>;
    var daList:Array<Array<Dynamic>> = [];
    ...
    public function new()
    {
		...
		statusText.setFormat(Paths.font("vcr.ttf"), 20, FlxColor.WHITE, CENTER);
		statusText.scrollFactor.set();
        statusText.setBorderStyle(FlxTextBorderStyle.OUTLINE, FlxColor.BLACK, 1.4);
		add(statusText);
    ...
    function changeSelection(change:Int = 0, playSound:Bool = true)
	{
        ...
        curSelected = FlxMath.wrap(curSelected + change, 0, daList.length - 1);
