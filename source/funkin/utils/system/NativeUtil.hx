package funkin.utils.system;

import lime.system.System;
import funkin.utils.system.Ansi;
...
class NativeUtil {
	 ...
	 * Shows a message box
	 */
	public static function showMessageBox(caption:String, message:String, icon:funkin.utils.system.PlatformUtil.MessageBoxIcon = MSG_WARNING) {
		#if windows
