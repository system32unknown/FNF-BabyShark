...
class Highscore {
	...
	public static var songRatings:Map<String, Float> = [];
	...
	public static function saveScore(song:String, score:Int, diff:Int = 0, rating:Float = -1):Void {
		...
		if (prevScore == null || score > prevScore) {
			...
			if (rating >= 0) songRatings.set(key, rating);
			save(SCORE);
		}
	}
	...
	public static function getRating(song:String, diff:Int):Float {
		return songRatings.get(Song.format(song, diff)) ?? 0;
	}
	...
	public static function load():Void {
		...
		if (_save.data.songRating != null) songRatings = _save.data.songRatings;
