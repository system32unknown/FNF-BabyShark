...
class Event
{
	...
	**/
	...
	/**
		The `Event.SOUND_LOOP` constant defines the value of the `type`
		property of a `soundLoop` event object.
		This event has the following properties:
		...
		| `cancelable` | `false`; there is no default behavior to cancel. |
		| `currentTarget` | The object that is actively processing the Event object with an event listener. |
		| `target` | The SoundChannel object in which a sound has looped. |
	**/
	public static inline var SOUND_LOOP:EventType<Event> = "soundLoop";
